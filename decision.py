...
def run(epochs=150, file="network2.h5"):
    ...
    Ran a neural net and tested it on our images. Now nn does this on it's own.
    """
...
def plot_history(history):
    """
    Takes the data from the traniing of the neural network and plots
    the loss and accuracy of the training and validation data sets.
    """
